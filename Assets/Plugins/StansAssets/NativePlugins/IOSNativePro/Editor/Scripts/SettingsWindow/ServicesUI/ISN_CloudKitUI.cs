...
namespace SA.iOS
{
    class ISN_CloudKitUI : ISN_ServiceSettingsUI
    {
        ...
        public override string Description => " Leverage the full power of iCloud and build apps for all Apple platforms with CloudKit. Easily and securely store and efficiently retrieve your app data in a database or assets right from iCloud.";

        protected override Texture2D Icon => EditorAssetDatabase.GetTextureAtPath(ISN_Skin.IconsPath + "Cloud-icon.png");

        public override SA_iAPIResolver Resolver => ISN_Preprocessor.GetResolver<ISN_CloudKitResolver>();
